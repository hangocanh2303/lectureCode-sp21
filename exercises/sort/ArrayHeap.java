...
public class ArrayHeap<T> implements ExtrinsicPQ<T> {
    ...
    private void swim(int index) {
        ...
        double parentNodePriority = contents[parent].myPriority;
        double currentNodePriority = contents[index].myPriority;
        if (parentNodePriority > currentNodePriority) {
            swap(parent, index);
            swim(parent);
        }
    }
    ...
    private void sink(int index) {
        ...
        if (contents[index].myPriority > contents[minChildIndex].myPriority) {
